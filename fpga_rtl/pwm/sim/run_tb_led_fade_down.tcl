...
vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit   $RTL_SRC_PWM/led_fade_down.vhd
vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit   $RTL_SRC_PWM/pwm_gen.vhd



vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit   tb_led_fade_down.vhd

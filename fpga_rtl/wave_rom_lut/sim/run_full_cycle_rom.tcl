...
puts {
  ModelSim general compile script version 1.0 : Guillaume Vanroyen
}
...
set RTL_SRC_UUT     "../"
set RTL_SRC_ROM     "../../bram_fifo_ram_rom/"
...
vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit   $RTL_SRC_ROM/rom.vhd
vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit   $RTL_SRC_UUT/full_cycle_rom.vhd


vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit   tb_full_cycle_rom.vhd

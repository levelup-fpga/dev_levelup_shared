...
vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit   $RTL_BUS_OUT/bus2bram.vhd
vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit     $RTL_SRC_FIFO/dpram_sc_v2.vhd

vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit   $RTL_BUS_OUT/bus2k2000.vhd
vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit     $RTL_SRC_LED/led_k2000_reg_rw.vhd

vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit   $RTL_BUS_OUT/busXbar.vhd


vcom -work $WORK_LIB -$VHDL_VERSION $VIEW_SCOPE -explicit   tb_spi2bus_xbar.vhd
